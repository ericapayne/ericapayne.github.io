...
export const Opening = () => {
  ...
  const three = (
    <p>
      Welcome, I am a Software Engineer born and raised in Los Angeles. I have
      my Bachelors in Computer Science from California State University Los
      Angeles. I am passionate about <b> Web Development</b> and{" "}
      <b>Full Stack Development. </b>I am currently looking for my next
