...
export const About = () => {
  ...
  const skills = ['HTML/CSS', 'Sass/SCSS', 'Java', 'JavaScript', 'React','Python', 'React Native', 'SQL', 'Adobe CC', 'C#', 'Figma', 'Databses'];
      ...
      <section className="about-me" id="about">
        <h2 className="num-header">A Little About Me</h2>
          <div className="inner">
            ...
            <div className="mypic">
              <img width="350" height="385.2"  src={headshot} alt="Headshot"/>
            </div>
          </div>
      </section>
