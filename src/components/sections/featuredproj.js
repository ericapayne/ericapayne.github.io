            ...
            <li className="featured-list">
                <div className="project-content">
                  <div>
                    ...
                    <h3 className="project-title"><a href="https://github.com/ericapayne/spotify-jammming-project" alt="Spotify Jammming Project Github Link">Spotify Playlist Web App</a></h3>
              ...
              <li className="featured-list">
                <div className="project-content">
                  <div>
                    <p className="project-overline">Featured Project</p>
                    <h3 className="project-title"><a href="https://github.com/ericapayne/Book-exchange" alt="Book Exchange Project Github Link">Book Exchange Website</a></h3>
              ...
              <li className="featured-list">
                <div className="project-content">
                  <div>
                    <p className="project-overline">Featured Project</p>
                    <h3 className="project-title"><a href="https://github.com/ericapayne/Movie-Search-App" alt="Movie Search App Github Link">Movie Search Mobile App</a></h3>
              ...
              <li className="featured-list">
                <div className="project-content">
                  <div>
                    <p className="project-overline">Featured Project</p>
                    <h3 className="project-title"><a href="https://github.com/ericapayne/Alpaca-My-Bags-Unity-Game" alt="Alpaca Game Github Link">Unity Engine Game</a></h3>
