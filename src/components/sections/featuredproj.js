            ...
            <li className="featured-list">
                <div className="project-content">
                  <div>
                    ...
                    <div className="project-links"><a href="https://github.com/ericapayne/spotify-jammming-project" aria-label="Spotify Project Button"><i className="fa-brands fa-github"></i></a></div>
                  </div>
                </div>
              ...
              <li className="featured-list">
                <div className="project-content">
                  <div>
                    ...
                    <div className="project-links"><a href="https://github.com/ericapayne/Book-exchange" aria-label="Book Exchange Project Button"><i className="fa-brands fa-github"></i></a></div>
                  </div>
                </div>
              ...
              <li className="featured-list">
                <div className="project-content">
                  <div>
                    ...
                    <div className="project-links"><a href="https://github.com/ericapayne/Movie-Search-App" aria-label="Movie Search project Button"><i className="fa-brands fa-github"></i></a></div>
                  </div>
                </div>
              ...
              <li className="featured-list">
                <div className="project-content">
                  <div>
                    ...
                    <div className="project-links"><a href="https://github.com/ericapayne/Alpaca-My-Bags-Unity-Game" aria-label="Game project Button"><i className="fa-brands fa-github"></i></a></div>
                  </div>
                </div>
